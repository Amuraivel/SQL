...
DECLARE x  LONG;
SET x = 49999638;
SET y = 49999639; -- 49999639;


WHILE x  <= y DO

UPDATE tls_indicator_table inds JOIN 
 -- UPDATE tls_indicator_table inds 
(
SELECT docdb_family_id AS famID,
concat(
MAX(D02H),
MAX(D02J),
MAX(D03C),
...
GROUP BY appln_id
) IPCbits JOIN tls218_docdb_fam USING(appln_id)
...
WHERE inds.docdb_family_id  BETWEEN @a AND @b;
